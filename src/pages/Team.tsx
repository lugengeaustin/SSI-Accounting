  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-4 max-[980px]:grid-cols-1">
        <Card>
          <div className="border-b border-line px-[18px] py-3.5"><h3 className="text-[15px] font-bold">Members</h3></div>
        ...
        <Card>
          <div className="border-b border-line px-[18px] py-3.5"><h3 className="text-[15px] font-bold">Authorised emails</h3></div>
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
